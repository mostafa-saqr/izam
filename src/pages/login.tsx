...
const Login = () => {
  ...
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: '#f7f8fa', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <Paper
        elevation={0}
        sx={{
          width: '100%',
      ...
      >
        ...
        <Box sx={{ mb: 2, display: 'flex', justifyContent: 'center', width: '100%' }}>
          <img src="/izam-logo.png" alt="izam logo" style={{ width: 113, height: 'auto', objectFit: 'contain' }} />
        </Box>
